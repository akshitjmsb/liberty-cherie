      ...
      <section className="bg-gradient-to-br from-cream via-white to-secondary-light/10 py-16">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <h1 className="font-display text-4xl text-charcoal mb-4">Terms of Service</h1>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="space-y-8 text-soft-gray">
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Agreement to Terms</h2>
                <p>
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Products and Services</h2>
                <p className="mb-4">
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Pricing and Payment</h2>
                <ul className="list-disc list-inside space-y-2">
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Orders and Fulfillment</h2>
                <ul className="list-disc list-inside space-y-2">
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Custom Orders</h2>
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Intellectual Property</h2>
                <p>
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">User Conduct</h2>
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Limitation of Liability</h2>
                <p>
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Product Care</h2>
                <p>
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Governing Law</h2>
                <p>
              ...
              <div>
                <h2 className="font-display text-xl text-charcoal mb-4">Changes to Terms</h2>
                <p>
